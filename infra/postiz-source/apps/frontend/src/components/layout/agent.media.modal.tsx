    ...
    <div className="flex flex-col gap-[20px] max-w-[520px]">
      <div className="text-[14px] leading-[22px] text-newTextColor opacity-80">
        {t(
          ...
          'UGC videos are powered by AgentMedia (agent-media.ai), a separate product with its own account and pricing — not part of your CEMATYS Auto Post AI subscription.'
        )}
      </div>
