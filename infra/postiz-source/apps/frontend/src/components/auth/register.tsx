          ...
          <div className="flex flex-col text-[14px]">
            ...
            <div className="flex flex-col gap-[12px]">
              ...
              <div className={clsx('text-[12px]')}>
                ...
                &nbsp;
                <a
                  href={`https://cematys.fr`} /* TODO: remplacer par une vraie page CGU CEMATYS Auto Post AI */
                ...
                {t('and', 'and')}&nbsp;
                <a
                  href={`https://cematys.fr`} /* TODO: remplacer par une vraie page confidentialité CEMATYS Auto Post AI */
                  rel="nofollow"
                  className="underline hover:font-bold"
                >
